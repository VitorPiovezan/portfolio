...
to {
  ...
  animation: ${G} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,_=({toast:t})=>{let{icon:e,type:i,iconTheme:s}=t;return void 0!==e?"string"==typeof e?r.createElement(Q,null,e):e:"blank"===i?null:r.createElement(H,null,r.createElement(K,{...s}),"loading"!==i&&r.createElement(z,null,"error"===i?r.createElement(q,{...s}):r.createElement(N,{...s})))},B=v("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
